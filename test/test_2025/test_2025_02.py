...
from advent_of_code.year_2025.day_02.day_02 import validate_code, validate_range, parse_ranges, validate_ranges, prime_factors, validate_code2, all_multiples


test_file = StringIO('11-22,95-115,998-1012,1188511880-1188511890,222220-222224,1698522-1698528,446443-446449,38593856-38593862,565653-565659,824824821-824824827,2121212118-2121212124')
...
def test_range():
    ...
    for r in ranges:
        ...
        assert sum_invalid == r['invalid_sum'], f'Sum error in range {r['range_']}. Got {sum_invalid}, should be {r['invalid_sum']}'
...
def test_all_multiples():
    mult = all_multiples(100)
    assert mult == {1, 2, 4, 5, 10, 50, 20, 25}